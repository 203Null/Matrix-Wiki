...
Note: The system log level can be set to debug by using build-dev in build command. All other command has log level None. If you are using build, the default log level in the os/Parameters.h file will be used. (See <DocLink to="/docs/Developer/DebugMatrixOSCpp">Debug Matrix OS</DocLink> for more information.) 
