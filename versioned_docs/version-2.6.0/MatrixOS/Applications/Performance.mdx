...
To exit the Performance App, enter the action menu and hold down the function key. You will be brought back to the [application launcher](/docs/MatrixOS/ApplicationLauncher). This is the standard method for exiting an app in Matrix OS.
