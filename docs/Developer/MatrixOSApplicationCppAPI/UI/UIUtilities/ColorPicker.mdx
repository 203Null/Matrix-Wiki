...
For user interaction usage. See <DocLink to="/docs/MatrixOS/SharedUI/ColorPicker">Color Picker</DocLink>.

*The source file for this UI utility is located in <GithubLink path="OS/UI/UIUtilities.h"/> and it is implemented in <GithubLink path="OS/UI/Utilities/ColorPicker.cpp"/>.*
---
