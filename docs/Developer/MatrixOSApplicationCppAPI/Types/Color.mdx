...
*The header file for this class is located in <GithubLink path="OS/Framework/Color/Color.h"/> and the implementation is in <GithubLink path="OS/Framework/Color/Color.cpp"/>.*
