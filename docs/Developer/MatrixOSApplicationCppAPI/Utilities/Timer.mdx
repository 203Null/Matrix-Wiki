...
*The header file for this utility is located in <GithubLink path="OS/Framework/Timer/Timer.h"/> and the implementation is in <GithubLink path="OS/Framework/Timer/Timer.cpp"/>.*
