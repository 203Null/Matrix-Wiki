...
Use the full example suite when you are validating the Matrix OS source tree itself. The example suite can fail because of an example app or simulator regression even when your own snippet runs correctly.
