...
Additionally, there are some pre made UI interfaces that you can use directly, like color picker, number selector, text scroll, etc. See the <DocLink to="/docs/category/utilities">UI Utilities</DocLink> documentation for more information.
...
**Parameters:**
- `uiComponent` (<DocLink to="/docs/category/ui-components">`UIComponent*`</DocLink>): The component to add.
